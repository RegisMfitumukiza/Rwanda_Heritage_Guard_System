...
const EducationalSection = ({
    ...
    const defaultTitle = title || t('education.title');
    const defaultSubtitle = subtitle || t('education.subtitle');
    const defaultDescription = description || t('education.description');
